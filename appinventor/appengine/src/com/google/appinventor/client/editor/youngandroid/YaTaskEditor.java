 ...
 * tasks.</p>
 */
public final class YaTaskEditor extends SimpleEditor implements FormChangeListener {
  ...
  YaTaskEditor(ProjectEditor projectEditor, YoungAndroidTaskNode taskNode) {
    ...
    nonVisibleComponentsPanel = new SimpleNonVisibleComponentsPanel(true);
  ...
  public Map<String, MockComponent> getComponents() {
    ...
    if (loadComplete) {
      ...
      OdeLog.log("YaTaskEditor: about to return an empty map!!!!!");
    }
    return map;
  }
  ...
  private void onFileLoaded(String content) {
    ...
    nonVisibleComponentsPanel.setForm(task);
    task.select();
  ...
  public String encodeFormAsJsonString() {
    ...
    encodeComponentProperties(task, sb);
    sb.append("}");
    return sb.toString();
  }
  ...
  private void updatePhone() {
    YaProjectEditor yaProjectEditor = (YaProjectEditor) projectEditor;
    YaBlocksEditor blockEditor = yaProjectEditor.getBlocksFileEditor(taskNode.getFormName());
    blockEditor.onBlocksAreaChanged(getProjectId() + "_" + taskNode.getFormName());
  }
